...
#Intro
echo "${yellow}Checking for kali hardening..${reset}"
read pause
...
echo "${blue}Chkrootkit in progress.. Log will be saved in ./OSHardeningLogs/chkrootkit_log.txt.${reset}"
sudo chkrootkit > ./OSHardeningLogs/chkrootkit_log.txt
echo "${blue}Lynis in progress.. Log will be saved in ./OSHardeningLogs/lynis_log.txt.${reset}"
lynis audit system -Q > ./OSHardeningLogs/lynis_log.txt
echo "${blue}Rkhunter in progress..${reset}"
